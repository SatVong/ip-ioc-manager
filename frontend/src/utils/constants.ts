...
export const IP_RECORD_COLUMNS: ColumnDef<any>[] = [
  ...
  { label: 'Раздел письма', key: 'letter', sortable: true, filterable: true, width: '150px' },
  ...
  { label: 'Страна (2 буквы)*', key: 'country', type: 'country', sortable: true, filterable: true, width: '150px' },
  ...
  { label: 'Кто вносит', key: 'who_in', type: 'readonly', sortable: true, filterable: true, width: '180px' },
  { label: 'Примечание к исключению', key: 'note_out', type: 'readonly', sortable: true, filterable: true, width: '230px' },
  { label: 'Дата исключения', key: 'date_out', type: 'readonly', sortable: true, filterable: true, width: '150px' },
  { label: 'Кто исключил', key: 'who_out', type: 'readonly', sortable: true, filterable: true, width: '180px' },
]
...
export const IOC_RECORD_COLUMNS: ColumnDef<any>[] = [
  ...
  { label: 'Примечание к внесению', key: 'note_in', sortable: true, filterable: true, width: '200px' },
  { label: 'Дата внесения', key: 'date_in', type: 'readonly', sortable: true, filterable: true, width: '150px' },
  { label: 'Кто вносил', key: 'who_in', type: 'readonly', sortable: true, filterable: true, width: '180px' },
  { label: 'Примечание к исключению', key: 'note_out', type: 'readonly', sortable: true, filterable: true, width: '230px' },
  { label: 'Дата исключения', key: 'date_out', type: 'readonly', sortable: true, filterable: true, width: '150px' },
  { label: 'Кто исключил', key: 'who_out', type: 'readonly', sortable: true, filterable: true, width: '180px' },
]
